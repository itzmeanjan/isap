...
// Compile it with
//
// g++ -Wall -std=c++20 -O3 -I ./include example/isap_k_128a.cpp
int
main()
{
  ...
  // verified decryption
  bool f = isap_k_128a::decrypt(key, nonce, tag, data, dlen, enc, dec, mlen);
...

  {
    ...
    std::cout << "ISAP-K-128A AEAD" << std::endl << std::endl;
