...
// Compile it with
//
// g++ -Wall -std=c++20 -O3 -I ./include example/isap_a_128a.cpp
int
main()
{
  ...
  // verified decryption
  bool f = isap_a_128a::decrypt(key, nonce, tag, data, dlen, enc, dec, mlen);
...

  {
    ...
    std::cout << "ISAP-A-128A AEAD" << std::endl << std::endl;
